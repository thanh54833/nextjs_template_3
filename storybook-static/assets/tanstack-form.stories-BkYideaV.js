...
</form.Form>`})]}),e.jsxs("div",{className:"text-xs text-muted-foreground",children:["See ",e.jsx("code",{children:"src/components/forms/fields/"})," for individual field implementations."]})]})};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
...
}`,...o.parameters?.docs?.source}}};const l=["Overview"];export{o as Overview,l as __namedExportsOrder,i as default};
