import{j as e}from"./jsx-runtime-EKYJJIwR.js";import{R as g,r as re}from"./index-Br2IOmUs.js";import{c as ae}from"./utils-BQHNewu7.js";import{a as ve,t as Ge}from"./toggle-t5SkCElM.js";import{c as Te}from"./index-BRlNe44M.js";import{P as C}from"./index-Caz76J1-.js";import{c as te,I as Ie,R as be}from"./index-x4TqUDAk.js";import{u as ne}from"./index-D7wzBi_S.js";import{u as fe}from"./index-Bal2i3vH.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-D1SQP9Z-.js";import"./index-DW48STyt.js";import"./index-BI3c041M.js";import"./index-CGqftQ-p.js";import"./index-B1gorirK.js";import"./index-OvQM5fGA.js";import"./index-BBh8-vjY.js";import"./index-1oe2SjNl.js";import"./index-DLhQgCaF.js";var p="ToggleGroup",[ie]=Te(p,[te]),se=te(),y=g.forwardRef((o,l)=>{const{type:r,...a}=o;if(r==="single"){const t=a;return e.jsx(xe,{...t,ref:l})}if(r==="multiple"){const t=a;return e.jsx(he,{...t,ref:l})}throw new Error(`Missing prop \`type\` expected on \`${p}\``)});y.displayName=p;var[ue,ge]=ie(p),xe=g.forwardRef((o,l)=>{const{value:r,defaultValue:a,onValueChange:t=()=>{},...i}=o,[u,s]=ne({prop:r,defaultProp:a??"",onChange:t,caller:p});return e.jsx(ue,{scope:o.__scopeToggleGroup,type:"single",value:g.useMemo(()=>u?[u]:[],[u]),onItemActivate:s,onItemDeactivate:g.useCallback(()=>s(""),[s]),children:e.jsx(pe,{...i,ref:l})})}),he=g.forwardRef((o,l)=>{const{value:r,defaultValue:a,onValueChange:t=()=>{},...i}=o,[u,s]=ne({prop:r,defaultProp:a??[],onChange:t,caller:p}),c=g.useCallback(m=>s((v=[])=>[...v,m]),[s]),j=g.useCallback(m=>s((v=[])=>v.filter(me=>me!==m)),[s]);return e.jsx(ue,{scope:o.__scopeToggleGroup,type:"multiple",value:u,onItemActivate:c,onItemDeactivate:j,children:e.jsx(pe,{...i,ref:l})})});y.displayName=p;var[je,ye]=ie(p),pe=g.forwardRef((o,l)=>{const{__scopeToggleGroup:r,disabled:a=!1,rovingFocus:t=!0,orientation:i,dir:u,loop:s=!0,...c}=o,j=se(r),m=fe(u),v={role:"group",dir:m,...c};return e.jsx(je,{scope:r,rovingFocus:t,disabled:a,children:t?e.jsx(be,{asChild:!0,...j,orientation:i,dir:m,loop:s,children:e.jsx(C.div,{...v,ref:l})}):e.jsx(C.div,{...v,ref:l})})}),h="ToggleGroupItem",de=g.forwardRef((o,l)=>{const r=ge(h,o.__scopeToggleGroup),a=ye(h,o.__scopeToggleGroup),t=se(o.__scopeToggleGroup),i=r.value.includes(o.value),u=a.disabled||o.disabled,s={...o,pressed:i,disabled:u},c=g.useRef(null);return a.rovingFocus?e.jsx(Ie,{asChild:!0,...t,focusable:!u,active:i,ref:c,children:e.jsx(_,{...s,ref:l})}):e.jsx(_,{...s,ref:l})});de.displayName=h;var _=g.forwardRef((o,l)=>{const{__scopeToggleGroup:r,value:a,...t}=o,i=ge(h,r),u={role:"radio","aria-checked":o.pressed,"aria-pressed":void 0},s=i.type==="single"?u:void 0;return e.jsx(ve,{...s,...t,ref:l,onPressedChange:c=>{c?i.onItemActivate(a):i.onItemDeactivate(a)}})}),Ce=y,_e=de;const ce=re.createContext({size:"default",variant:"default"});function d({className:o,variant:l,size:r,children:a,...t}){return e.jsx(Ce,{"data-slot":"toggle-group","data-variant":l,"data-size":r,className:ae("group/toggle-group flex w-fit items-center rounded-md data-[variant=outline]:shadow-xs",o),...t,children:e.jsx(ce.Provider,{value:{variant:l,size:r},children:a})})}function n({className:o,children:l,variant:r,size:a,...t}){const i=re.useContext(ce);return e.jsx(_e,{"data-slot":"toggle-group-item","data-variant":i.variant||r,"data-size":i.size||a,className:ae(Ge({variant:i.variant||r,size:i.size||a}),"min-w-0 flex-1 shrink-0 rounded-none shadow-none first:rounded-l-md last:rounded-r-md focus:z-10 focus-visible:z-10 data-[variant=outline]:border-l-0 data-[variant=outline]:first:border-l",o),...t,children:l})}d.__docgenInfo={description:"",methods:[],displayName:"ToggleGroup"};n.__docgenInfo={description:"",methods:[],displayName:"ToggleGroupItem"};const He={component:d,tags:["autodocs"],parameters:{docs:{description:{component:"A toggle group component for managing multiple related toggle buttons. Supports single-selection (only one pressed at a time) and multiple-selection modes."}}}},G={render:()=>e.jsxs(d,{defaultValue:"bold",type:"single",children:[e.jsx(n,{value:"bold","aria-label":"Bold",children:"B"}),e.jsx(n,{value:"italic","aria-label":"Italic",children:"I"}),e.jsx(n,{value:"underline","aria-label":"Underline",children:"U"})]})},T={render:()=>e.jsxs(d,{type:"multiple",defaultValue:["bold","italic"],children:[e.jsx(n,{value:"bold","aria-label":"Bold",children:"B"}),e.jsx(n,{value:"italic","aria-label":"Italic",children:"I"}),e.jsx(n,{value:"underline","aria-label":"Underline",children:"U"})]})},I={render:()=>e.jsxs(d,{type:"single",defaultValue:"center",children:[e.jsx(n,{value:"left","aria-label":"Left",children:"Left"}),e.jsx(n,{value:"center","aria-label":"Center",children:"Center"}),e.jsx(n,{value:"right","aria-label":"Right",children:"Right"})]})},b={render:()=>e.jsxs(d,{defaultValue:"bold",variant:"outline",type:"single",children:[e.jsx(n,{value:"bold","aria-label":"Bold",children:"B"}),e.jsx(n,{value:"italic","aria-label":"Italic",children:"I"}),e.jsx(n,{value:"underline","aria-label":"Underline",children:"U"})]})},f={render:()=>e.jsxs(d,{defaultValue:"bold",size:"sm",type:"single",children:[e.jsx(n,{value:"bold","aria-label":"Bold",children:"B"}),e.jsx(n,{value:"italic","aria-label":"Italic",children:"I"}),e.jsx(n,{value:"underline","aria-label":"Underline",children:"U"})]})},x={render:()=>e.jsxs(d,{disabled:!0,defaultValue:"bold",type:"single",children:[e.jsx(n,{value:"bold","aria-label":"Bold",children:"B"}),e.jsx(n,{value:"italic","aria-label":"Italic",children:"I"})]})};var B,P,V,S,R;G.parameters={...G.parameters,docs:{...(B=G.parameters)==null?void 0:B.docs,source:{originalSource:`{
