...
}`,...i.parameters?.docs?.source},description:{story:"Default frame with title, description, and action buttons.",...i.parameters?.docs?.description}}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
...
}`,...d.parameters?.docs?.source},description:{story:"Multiple stacked panels for list-based content.",...d.parameters?.docs?.description}}};m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`{
  render: () => <Frame className="w-full max-w-lg">
      <FramePanel>
        <FrameHeader>
...
}`,...m.parameters?.docs?.source},description:{story:"Frame with list content and footer action.",...m.parameters?.docs?.description}}};c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`{
  render: () => <Frame className="w-full max-w-lg">
      <FramePanel>
        <FrameHeader>
...
}`,...c.parameters?.docs?.source},description:{story:"Frame with form fields for settings pages.",...c.parameters?.docs?.description}}};p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
...
}`,...p.parameters?.docs?.source},description:{story:"Card-style frames for dashboard grid layouts.",...p.parameters?.docs?.description}}};const H=["Default","StackedPanels","WithList","WithForm","CardStyle"];export{p as CardStyle,i as Default,d as StackedPanels,c as WithForm,m as WithList,H as __namedExportsOrder,C as default};
