...
}`,...(u=(p=o.parameters)==null?void 0:p.docs)==null?void 0:u.source},description:{story:"Default modal with title, description, and action buttons.",...(f=(m=o.parameters)==null?void 0:m.docs)==null?void 0:f.description}}};var x,h,j,C,g;a.parameters={...a.parameters,docs:{...(x=a.parameters)==null?void 0:x.docs,source:{originalSource:`{
  render: () => {
    const [isOpen, setIsOpen] = React.useState(false);
    return <>
...
}`,...(B=(w=l.parameters)==null?void 0:w.docs)==null?void 0:B.source},description:{story:"Success confirmation modal for completed actions.",...(D=(k=l.parameters)==null?void 0:k.docs)==null?void 0:D.description}}};const de=["Default","WithForm","AlertModal","SuccessModal"];export{i as AlertModal,o as Default,l as SuccessModal,a as WithForm,de as __namedExportsOrder,ce as default};
