import{j as s}from"./jsx-runtime-u17CrQMm.js";import{I as R}from"./next-image-B_ObWQ8f.js";import{I as i}from"./icons-BdTSAv6R.js";import{c as a}from"./utils-Czy_q_oT.js";import"./index-DYby6Z_P.js";import"./_commonjsHelpers-Cpj98o6Y.js";const j=e=>{const n=e.split(".");return n.length>1?n[n.length-1]:""},N=(e,n)=>{const r=j(n).toLowerCase(),o={size:24};return e.startsWith("image/")?s.jsx(i.media,{...o,className:"text-emerald-500 dark:text-emerald-400"}):e==="application/pdf"||r==="pdf"?s.jsx(i.fileTypePdf,{...o,className:"text-red-500 dark:text-red-400"}):["doc","docx","odt","rtf"].includes(r)||e.includes("wordprocessing")||e.includes("msword")?s.jsx(i.fileTypeDoc,{...o,className:"text-blue-500 dark:text-blue-400"}):["xls","xlsx","csv","ods"].includes(r)||e.includes("spreadsheet")||e.includes("excel")?s.jsx(i.fileTypeXls,{...o,className:"text-green-500 dark:text-green-400"}):["txt","md"].includes(r)||e==="text/plain"?s.jsx(i.post,{...o,className:"text-zinc-500 dark:text-zinc-400"}):["js","ts","jsx","tsx","py","java","c","cpp","html","css"].includes(r)||e.includes("javascript")||e.includes("typescript")?s.jsx(i.code,{...o,className:"text-yellow-500 dark:text-yellow-400"}):["json","xml","yaml","yml"].includes(r)?s.jsx(i.code,{...o,className:"text-zinc-500 dark:text-zinc-400"}):e.startsWith("video/")||["mp4","avi","mov","mkv"].includes(r)?s.jsx(i.video,{...o,className:"text-purple-500 dark:text-purple-400"}):e.startsWith("audio/")||["mp3","wav","ogg"].includes(r)?s.jsx(i.music,{...o,className:"text-pink-500 dark:text-pink-400"}):["zip","rar","tar","gz","7z"].includes(r)||e.includes("archive")||e.includes("compressed")?s.jsx(i.fileZip,{...o,className:"text-amber-500 dark:text-amber-400"}):s.jsx(i.page,{...o,className:"text-zinc-500 dark:text-zinc-400"})},b=(e,n)=>{const r=j(n).toUpperCase();if(e.includes("msword")||e.includes("wordprocessing"))return"DOC";if(e.includes("spreadsheet")||e.includes("excel"))return"SPREADSHEET";const o=e.split("/")[1];return!o||o==="octet-stream"?r||"FILE":o.replace("vnd.openxmlformats-officedocument.","").replace("vnd.ms-","").replace("x-","").replace("document.","").replace("presentation.","").replace("application.","").split(".")[0].toUpperCase().substring(0,8)},w=({files:e,onRemove:n,className:r,variant:o="default"})=>{const p=o==="inverted";return e.length===0?null:s.jsx("div",{className:a("flex w-full flex-col gap-2 rounded-xl p-2",r),children:s.jsx("div",{className:"flex w-full flex-wrap gap-2",children:e.map(t=>s.jsxs("div",{className:a("group/file relative flex items-center rounded-xl transition-all",p?"bg-primary-foreground/15 hover:bg-primary-foreground/20":"bg-muted hover:bg-muted/80",t.type.startsWith("image/")&&t.url?"h-14 w-14 justify-center":"max-w-[220px] min-w-[180px] p-2 pr-8"),children:[t.isUploading&&s.jsx("div",{className:"absolute inset-0 flex items-center justify-center rounded-xl bg-black/30",children:s.jsx(i.spinner,{size:20,className:"animate-spin text-white"})}),n&&s.jsx("button",{type:"button",onClick:()=>n(t.id),className:a("absolute -top-1 -right-1 z-10 flex h-5 w-5 items-center justify-center rounded-full","scale-75 opacity-0 transition-all duration-150 group-hover/file:scale-100 group-hover/file:opacity-100","bg-muted-foreground/60 hover:bg-muted-foreground/80 cursor-pointer"),"aria-label":`Remove ${t.name}`,children:s.jsx(i.close,{size:10,className:"text-white"})}),t.type.startsWith("image/")&&t.url?s.jsx("div",{className:"h-12 w-12 overflow-hidden rounded-md",children:s.jsx(R,{width:48,height:48,src:t.url,alt:t.name,className:"h-full w-full object-cover"})}):s.jsxs(s.Fragment,{children:[s.jsx("div",{className:a("mr-3 flex h-10 w-10 items-center justify-center rounded-lg",p?"bg-primary-foreground/10":"bg-muted-foreground/10"),children:N(t.type,t.name)}),s.jsxs("div",{className:"flex min-w-0 flex-1 flex-col",children:[s.jsx("p",{className:a("truncate text-sm font-medium",p?"text-primary-foreground":"text-foreground"),children:t.name.length>18?`${t.name.substring(0,15)}...`:t.name}),s.jsx("span",{className:a("text-xs",p?"text-primary-foreground/70":"text-muted-foreground"),children:b(t.type,t.name)})]})]})]},t.id))})})};w.__docgenInfo={description:"",methods:[],displayName:"FilePreview",props:{files:{required:!0,tsType:{name:"Array",elements:[{name:"UploadedFile"}],raw:"UploadedFile[]"},description:""},onRemove:{required:!1,tsType:{name:"signature",type:"function",raw:"(id: string) => void",signature:{arguments:[{type:{name:"string"},name:"id"}],return:{name:"void"}}},description:""},className:{required:!1,tsType:{name:"string"},description:""},variant:{required:!1,tsType:{name:"union",raw:"'default' | 'inverted'",elements:[{name:"literal",value:"'default'"},{name:"literal",value:"'inverted'"}]},description:"",defaultValue:{value:"'default'",computed:!1}}}};const U={component:w,tags:["autodocs"],parameters:{layout:"padded",docs:{description:{component:"A file preview component that displays uploaded files with type-specific icons and remove functionality."}}}},y=[{id:"1",name:"project-proposal.pdf",type:"application/pdf",url:"/placeholder.pdf"},{id:"2",name:"dashboard-mockup.fig",type:"application/figma",url:"/placeholder"},{id:"3",name:"data-analysis.xlsx",type:"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"},{id:"4",name:"readme.md",type:"text/markdown"}],d={args:{files:y,onRemove:e=>console.log("Remove file:",e)}},l={args:{files:[{id:"img-1",name:"hero-image.jpg",type:"image/jpeg",url:"https://picsum.photos/200"},{id:"img-2",name:"logo.png",type:"image/png",url:"https://picsum.photos/201"}],onRemove:e=>console.log("Remove file:",e)}},c={args:{files:y,variant:"inverted",onRemove:e=>console.log("Remove file:",e)}},m={args:{files:[{id:"1",name:"uploading-file.pdf",type:"application/pdf",isUploading:!0},{id:"2",name:"completed-file.docx",type:"application/vnd.openxmlformats-officedocument.wordprocessingml.document",url:"/placeholder"},{id:"3",name:"another-uploading.jpg",type:"image/jpeg",isUploading:!0,url:"https://picsum.photos/200"}],onRemove:e=>console.log("Remove file:",e)}},u={args:{files:[{id:"1",name:"product-demo.mp4",type:"video/mp4",url:"/placeholder"}],onRemove:e=>console.log("Remove file:",e)}},g={args:{files:[{id:"1",name:"podcast-ep-12.mp3",type:"audio/mpeg",url:"/placeholder"}],onRemove:e=>console.log("Remove file:",e)}},f={args:{files:[{id:"1",name:"source-code.zip",type:"application/zip",url:"/placeholder"}],onRemove:e=>console.log("Remove file:",e)}},h={args:{files:y}},v={args:{files:[{id:"1",name:"document.pdf",type:"application/pdf"},{id:"2",name:"image-photo.jpg",type:"image/jpeg",url:"https://picsum.photos/202"},{id:"3",name:"spreadsheet.xlsx",type:"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"},{id:"4",name:"code.ts",type:"text/typescript"},{id:"5",name:"video-promo.mp4",type:"video/mp4"},{id:"6",name:"archive.tar.gz",type:"application/gzip"}],onRemove:e=>console.log("Remove file:",e)}},x={args:{files:[{id:"1",name:"profile-photo.jpg",type:"image/jpeg",url:"https://picsum.photos/203"}],onRemove:e=>console.log("Remove file:",e)}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
  args: {
    files: sampleFiles,
...
}`,...x.parameters?.docs?.source},description:{story:"Single image preview with larger display.",...x.parameters?.docs?.description}}};const A=["Default","WithImages","InvertedVariant","WithUploadingFiles","WithVideoFile","WithAudioFile","WithArchiveFile","WithoutRemoveButton","MixedFileTypes","SingleImage"];export{d as Default,c as InvertedVariant,v as MixedFileTypes,x as SingleImage,f as WithArchiveFile,g as WithAudioFile,l as WithImages,m as WithUploadingFiles,u as WithVideoFile,h as WithoutRemoveButton,A as __namedExportsOrder,U as default};
